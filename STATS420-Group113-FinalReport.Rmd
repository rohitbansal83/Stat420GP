...
aggregate(nyc_data_clean$DOF.Gross.Floor.Area~nyc_data_clean$building_type, nyc_data_clean, mean)

nyc_data_clean$DOF.Gross.Floor.Area =   ifelse(is.na(nyc_data_clean$DOF.Gross.Floor.Area) & nyc_data_clean$building_type=="MultiFamilyHousing", 140789.4, as.numeric(nyc_data_clean$DOF.Gross.Floor.Area))

nyc_data_clean$DOF.Gross.Floor.Area =   ifelse(is.na(nyc_data_clean$DOF.Gross.Floor.Area) & nyc_data_clean$building_type=="Office", 308405.9, as.numeric(nyc_data_clean$DOF.Gross.Floor.Area))

nyc_data_clean$DOF.Gross.Floor.Area =   ifelse(is.na(nyc_data_clean$DOF.Gross.Floor.Area) & nyc_data_clean$building_type=="Others", 174541.1, as.numeric(nyc_data_clean$DOF.Gross.Floor.Area))
```

```{r}
aggregate(nyc_data_clean$Water.Intensity..All.Water.Sources...gal.ft.. ~ nyc_data_clean$building_type, nyc_data_clean, mean)

nyc_data_clean$DOF.Gross.Floor.Area =   ifelse(is.na(nyc_data_clean$Water.Intensity..All.Water.Sources...gal.ft..) & nyc_data_clean$building_type=="MultiFamilyHousing", 103.39159, as.numeric(nyc_data_clean$Water.Intensity..All.Water.Sources...gal.ft..))

nyc_data_clean$DOF.Gross.Floor.Area =   ifelse(is.na(nyc_data_clean$Water.Intensity..All.Water.Sources...gal.ft..) & nyc_data_clean$building_type=="Office", 42.79896, as.numeric(nyc_data_clean$Water.Intensity..All.Water.Sources...gal.ft..))

nyc_data_clean$DOF.Gross.Floor.Area =   ifelse(is.na(nyc_data_clean$Water.Intensity..All.Water.Sources...gal.ft..) & nyc_data_clean$building_type=="Others", 232.34960, as.numeric(nyc_data_clean$Water.Intensity..All.Water.Sources...gal.ft..))
```
