...
nyc_data_clean[which(nyc_data_clean$Water.Intensity..All.Water.Sources...gal.ft.. == "0"),][1:10]

aggregate(as.numeric(nyc_data_clean$Water.Intensity..All.Water.Sources...gal.ft..) ~ building_type, nyc_data_clean, c(Largest.Property.Use.Type, col) )
```
