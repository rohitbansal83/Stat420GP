...
#3
nyc_data_clean$Source.EUI..kBtu.ft.. = as.numeric(nyc_data_clean$Source.EUI..kBtu.ft..)
...
```{r}
#4
x = as.numeric(nyc_data_clean$Water.Intensity..All.Water.Sources...gal.ft..)
length(x)

col = 'Water.Intensity..All.Water.Sources...gal.ft..'
round(mean(nyc_data_clean[,col]=="Not Available"),4)
9642 * 0.323

#nyc_data_clean[which(nyc_data_clean$Water.Intensity..All.Water.Sources...gal.ft.. == "Not Available"), ]

nyc_data_clean$Water.Intensity..All.Water.Sources...gal.ft.. = ifelse(nyc_data_clean$Water.Intensity..All.Water.Sources...gal.ft..=="Not Available",0, as.numeric(nyc_data_clean$Water.Intensity..All.Water.Sources...gal.ft..) )

write.csv(nyc_data_clean, "nyc_data_clean_1.csv")
aggregate(as.double(nyc_data_clean$Water.Intensity..All.Water.Sources...gal.ft..) ~ building_type, nyc_data_clean, mean)
```
...
ifelse(is.na(nyc_data_clean$DOF.Gross.Floor.Area), 0, as.numeric(nyc_data_clean$DOF.Gross.Floor.Area))[1:10]
